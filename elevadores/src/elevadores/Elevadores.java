...
public class Elevadores {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i <= 49; i++) {
			...
			System.out.println("Escolha  o elevador que você mais utiliza ?(A, B, C)");
		...
		if(preferenciaA > preferenciaB && preferenciaA > preferenciaC) {                           
			...
			System.out.println("Elevador mais utilizado é o A, utilizado por "+preferenciaA+" pessoas");
		}
		
		else if(preferenciaB > preferenciaC && preferenciaB > preferenciaA)  {
			elevadorMaisUtilizado = preferenciaB;
			System.out.println("Elevador mais utilizado é o B, utilizado por "+preferenciaB+" pessoas");
			
		}else {
	
			System.out.println("Elevador mais utilizado é o C, utilizado por "+preferenciaC +" pessoas");
		...
		if(vespertino>noite && vespertino>manha) {
			...
			System.out.println("O maior fluxo ocorre no período vespertino, de "+ maiorFluxo +"pessoas");

			
		}else if(noite>vespertino && noite>manha){
			maiorFluxo = noite;
			System.out.println("O maior fluxo ocorre no período da noite, de "+ maiorFluxo +"pessoas");
		}
		
		else {
			maiorFluxo = manha;
			System.out.println("O maior fluxo ocorre no período da manhã, de "+ maiorFluxo +"pessoas");
